                    ...
                    @foreach ($locales as $locale)
                        <div class="flex flex-col mt-1">
                            ...
                            @error("grammar_theory.".$locale->locale)
                                <span class="text-red-600 text-xs">{{ $locale->name }} text field is required</span>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 my-2 " wire:ignore>
                            <div class="flex flex-col w-full mb-2">
                                ...
                                @error("text_correct_parts.".$i)
                                    <span class="text-red-600 text-xs -mt-4">text for correct words field is required</span>
                                @enderror
                            </div>
                            ...
                            <div class="flex flex-row items-end mb-2 ">
                                <div class="flex flex-col flex-1">
                                    ...
                                    @error("text_incorrect_parts.".$i)
                                        <span class="text-red-600 text-xs -mt-4">text for incorrect words field is required</span>
                                    @enderror
                                </div>  
