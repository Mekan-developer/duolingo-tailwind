        ...
        <div class="flex flex-row justify-between w-full">
            ...
            <div>
                <div class="flex flex-row-reverse">
                    <a href="{{route('audioTranslation.create')}}" class="text-white bg-[var(--bg-color-active)] hover:bg-[#46b8c0] focus:ring-4 font-medium rounded-sm px-4 py-2 me-2 mb-2">+</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                ...
                <tbody class="divide-y divide-gray-200">
                    @foreach ($audioTranslations as $audioTranslation)
                        <tr>
                            <td class="text-center whitespace-nowrap px-4 py-2 text-gray-700">{{$audioTranslation->en_text}}</td>
                            <td  class="px-6 py-4 ">
                            ...
                            <td class="text-center whitespace-nowrap px-4 py-2 text-gray-700">{{$audioTranslation->Chapter->translate('title',$locales[0]['locale'])}}</td>
                            <td class="text-center whitespace-nowrap px-4 py-2 text-gray-700">{{$audioTranslation->Lesson->translate('title',$locales[0]['locale'])}}</td>
                            <td class="text-center whitespace-nowrap px-4 py-2 text-gray-700">{{$audioTranslation->Exercise->translate('title',$locales[0]['locale'])}}</td>
                            
                            <td class="text-center whitespace-nowrap px-4 py-2 text-gray-700">{{$audioTranslation->order}}</td>
