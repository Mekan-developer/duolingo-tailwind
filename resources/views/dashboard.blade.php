...
<div class="flex flex-col gap-10 p-1">
    <div class="mx-auto ">
        ...
        <div class="grid grid-col-1 2xl:grid-cols-2 gap-14">
            ...
            <x-admin.card icon="bx bx-task" route="exercises" title="Exercises" count="{{$exercises}} Exercises" text="In this section belongs to exercises and each exercise  we can Edite and Reordering.In description column shown Instruction for each 11 (eleven) exercise :" />
            <x-admin.card icon="bx bx-book-reader" route="vocabulary.index" title="Exercise types" count="{{$allExercises}} Exercises" text="In this section you can manage all the types of tasks such as creating, deleting, editing, ordering and changing status:" />
