...
<div class="flex flex-col gap-10 p-1">
    <div class="mx-auto ">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-3 gap-10 xl:gap-20 2xl:gap-32">
            ...
            <x-admin.card icon="bx bx-task" route="exercises" title="exercise types" count="{{$exercises}} Exercises" text="In this section you can manage all the Exercises such as creating, deleting, editing and ordering:" />
